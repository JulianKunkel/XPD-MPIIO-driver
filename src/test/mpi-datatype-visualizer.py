...
typ = "VECTOR(count=1,blocklength=1,stride=1,typ=RESIZED(lb=0,typ=HINDEXED(count=1,blocklength=[1],displacement=[0],typ=VECTOR(count=1,blocklength=5,stride=1,typ=RESIZED(lb=0,typ=HINDEXED(count=1,blocklength=[1],displacement=[80],typ=VECTOR(count=1,blocklength=20,stride=1,typ=CONTIGUOUS(count=4,typ=NAMED(size=1,BYTE),size=4,extent=4),size=80,extent=80),size=80,extent=80),size=80,extent=400),size=400,extent=2000),size=400,extent=2000),size=400,extent=4000),size=400,extent=4000)"
...
def procVector(attribs, childType, o):
  c = attribs["count"]
  s = attribs["stride"]
  b = attribs["blocklength"]
  offset = int(s)
...
def procHindexed(attribs, childType, o):
  c = attribs["count"]
  d = attribs["displacement"]
  b = attribs["blocklength"]
  for i in range(0, int(c)):
    repeat(childType, b[i], d[i], o)
